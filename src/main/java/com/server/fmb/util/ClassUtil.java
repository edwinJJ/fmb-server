 ...
 *------------------------------------------------------------------------------
 *
 *  Source Name:    ClassUtil.java
 *  Description:  	Class에 관련된 다양한 기능들을 제공하는 클래스 
 *  Authors:        Y.S. Jung
 *  Update History:
...
import com.server.fmb.util.ClassUtil;
...
public class ClassUtil {
	...
	public static Object getFieldValue(Object instance, Field field) {
		try {
			if (ValueUtil.isEmpty(field) || ValueUtil.isEmpty(instance)) {
				return null;
			}
